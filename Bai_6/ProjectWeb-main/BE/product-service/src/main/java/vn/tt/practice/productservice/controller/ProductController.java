...
//        System.out.println("⏱️ Total response time: " + (end - start) + " ms");
    ...
    public ResponseEntity<ProductDTO> updateImage(@PathVariable String code, @RequestParam String url) {
        return ResponseEntity.ok(productService.updateImageByCode(code, url));
    }
